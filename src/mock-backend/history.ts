...
const WORDS = [
  'hey', 'thanks', 'love', 'the', 'new', 'video', 'so', 'much', 'today', 'shoot',
  'behind', 'scenes', 'coming', 'soon', 'what', 'did', 'you', 'think', 'about', 'it',
  'lighting', 'was', 'amazing', 'can', 'we', 'see', 'more', 'of', 'that', 'set',
  'next', 'week', 'working', 'on', 'something', 'special', 'haha', 'yes', 'totally', 'agree',
  'camera', 'lens', 'edit', 'tonight', 'live', 'stream', 'at', 'eight', 'see', 'there',
];
